...
def main():
    ...
    # Kiểm tra số phần tử hiện tại trên ngăn xếp
    print("Số phần tử hiện tại trên ngăn xếp:", stack.count())

    # Lấy phần tử ra khỏi ngăn xếp
    stack.pop()

    # Kiểm tra số phần tử hiện tại sau khi pop
    print("Số phần tử hiện tại trên ngăn xếp sau khi pop:", stack.count())
